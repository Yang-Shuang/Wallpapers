...
public final class ToastUtils {
     ...
     * @param text The text.
     */
    public static void showShort(@NonNull final CharSequence text, Context context) {
     ...
     * @param resId The resource id for text.
     */
    public static void showLong(@StringRes final int resId, Context context) {
    ...
    private static void show(@StringRes final int resId, final int duration, Context context) {
